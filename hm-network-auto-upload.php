...
class HMNetworkAutoUpload {
    ...
    public function __construct() {
        ...
        add_filter( 'add_attachment', array( $this, 'copy_file' ), 10, 2 );
    }
     ...
     */
    public function copy_file( $source_post_id ) {
        $this->write_log( 'copy_file' );
            ...
            if( $site['blog_id'] != $source_site_id ) {
                ...
                if( $source_parent_id && function_exists( 'mlp_get_linked_elements' ) ) {
                    ...
                    if( array_key_exists( $site['blog_id'], $relations ) ) {
                        $target_parent_id = $relations[$site['blog_id']];
                    }
                }
                ...
                if( !$upload_file['error'] ) {
                    ...
                    remove_filter( 'add_attachment', array( $this, 'copy_file' ) );
                    // create attachment
                    ...
                    if( !is_wp_error( $target_post_id ) ) {
                        ...
                        $this->write_log( 'before add_action' );
                    }
                }
            }
